...
export async function seedDatabase() {
  try {
    ...
    console.log('Products seeded:', productData);
    ...
    console.log('Variants seeded:', variantData);
    ...
    if (imageError) {
      console.log('Image error (may already exist):', imageError.message);
    } else {
      console.log('Images seeded:', imageData);
    }
